...
We usually run the latest version on the LAN. If you didn't update at home, or your Steam is in Offline Mode, you are behind.
...
## How to update on LAN?

**Steam:**
1. Right-click game > Properties > Updates.
2. Set to "Always keep this game updated".
3. Restart Steam.

**Battle.net:**
1. Click Options (gear) next to Play.
2. Select **Check for Updates**.

**Minecraft:**
1. In the launcher, check the version dropdown (left of Play).
2. Make sure **Latest Release** is selected, not a snapshot or old version.

**General tips:**
1. **Go Online:** Make sure Steam/Launcher is in Online Mode.
2. **Restart:** Many launchers only check for updates on startup.
3. **Local Cache:** We have a local cache server. Downloads should be fast (10-50 MB/s). If it's slow, check your DNS settings (set to Automatic / DHCP).

## Old Games and Patches

If we play a game not on Steam (e.g., Minetest, Xonotic, OpenArena):
