...
1. **Group stage:** Teams are split into groups and play each other within the group.
2. **Single elimination:** Group winners (and sometimes runners-up) are paired off. Lose and you're out.
3. **Grand final:** The last two teams play for the trophy.
...
1. **Warm-up:** The server loads the map and you get a few minutes to settle in. Test your settings, check your audio.
2. **Live:** The admin signals the start. Everything counts from here.
3. **Match end:** The admin records the result. Don't leave the server until you're told it's okay.
...
For how to sign up: [Tournaments & Team Sign-up](/logistics/tournaments/).
If you need help: [How to Get Help](/help/how-to-get-help/).
