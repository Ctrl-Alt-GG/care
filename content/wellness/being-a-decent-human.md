...
**Ez még belefér (Trash Talk):**
- "Hogy nem találtad el?"
- "Ez a kör az enyém volt."
- "Szerencséd volt, noob." (Ha haverok vagytok.)

**Ez már zaklatás (Harassment):**
- Folyamatosan ordibálni valakivel, aki kérte, hogy hagyd abba.
- Szexista, rasszista vagy homofób megjegyzések.
- Fizikai fenyegetés ("Megvárlak kint").
- Valaki felszerelésének szándékos rongálása.

**A szabály:** Ha valaki azt mondja, hogy elég, akkor elég. Ha folytatod, az zaklatás, és repülsz.

## Hogyan jelentsd

Ha valaki átlépi a határt veled vagy mással szemben:

1. **Szólj neki:** "Hagyd abba, ez nem vicces."
2. **Szólj a staffnak:**
   - Menj a szervezői pulthoz.
   - Írj ránk Discordon privátban, ha nem akarsz feltűnést.
