...
The most common questions about Ctrl-Alt-GG, answered.
...
Check the full [What to Bring guide](/what-to-bring/) for more details.

## What should I NOT bring?

**Speakers**, a **UPS**, or your own **network gear** (switches, routers, etc.). Don't plug in anything that isn't your gaming setup.
...
First come, first served. Early arrivals get more choice. If you have special needs (for example, a specific chair due to back problems), let the organizers know in advance.
...
Wi-Fi is available, but it's primarily intended for mobile devices and web browsing. For gaming, use Ethernet. If your PC doesn't have an Ethernet port, bring an adapter.
...
Check the [Network Troubleshooting guide](/network-troubleshooting/) for a step-by-step walkthrough. If the basics don't fix it, tell staff.

## How do I report a problem or concern?

Talk to any staff member or organizer directly, or bring it up on Discord. We handle things quickly and privately.
