...
Ha a [Hogyan működik a hálózat](/posts/how-the-network-works/) túl technikai volt, ez a gyorstalpaló segít megérteni a legfontosabb kifejezéseket.
...
**Ezért fontos:** Ha a gépedet "Automatikus" (DHCP) módra állítod, a szerverünk megmondja neki, mi az IP-címe, hol a kijárat (Gateway) és ki fordítja a neveket (DNS). Ha kézzel állítasz be valamit, azzal csak galibát okozol. Lásd: [IP beállítás alapok](/posts/ip-setup-basics/).
