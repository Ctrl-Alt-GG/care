...
*Note: For LAN gaming, you might need to switch to Private or allow the game through the firewall. See: [Firewall and Antivirus Checks](/posts/firewall-and-antivirus-checks/).*
...
The [best defense](/posts/before-you-arrive/) is keeping your OS and software up to date. Updates patch 99% of security vulnerabilities.
